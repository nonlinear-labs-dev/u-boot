...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"loaddts=load usb 0:0 ${fdtaddr} ${IMG_NAME} ${DTS_SIZE} ${DTS_START}\0" \
        "nlboot=run nlinit; echo '#### Checking Devices and Partitions ####'; mmc list; run showinfommc_0; run showinfommc_1; run tryusb;\0" \
        ...
        "showinfommc_0=mmc dev 0; if mmc rescan; then mmcinfo; mmc part; fi\0" \
        "showinfommc_1=mmc dev 1; if mmc rescan; then mmcinfo; mmc part; fi\0" \
