...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"loaddts=load usb 0:0 ${fdtaddr} ${IMG_NAME} ${DTS_SIZE} ${DTS_START}\0" \
        ...
        "infommcpartzero=echo '#### Info MMC, Part 1 ####'; mmc dev 0 1; mmc rescan; mmcinfo; mmc part;\0" \
        "infommcpartone=echo '#### Info MMC, Part 2 ####'; mmc dev 0 2; mmc rescan; mmcinfo; mmc part;\0" \
        "infoemmcpartzero=echo '#### Info eMMC, Part 1 ####'; mmc dev 1 1; mmc rescan; mmcinfo; mmc part;\0" \
        "infoemmcpartone=echo '#### Info eMMC, Part 2 ####'; mmc dev 1 2; mmc rescan; mmcinfo; mmc part;\0" \
